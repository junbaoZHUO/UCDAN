...
with tf.name_scope("cross_ent"):
    ...
    source_samples_fc8 = tf.slice(score, [0, 0], [batch_size, 31])
    target_samples_fc8 = tf.slice(score, [batch_size, 0], [batch_size, 31])
...
with tf.Session() as sess:
    ...
    for epoch in range(num_epochs):
        ...
        for step in range(train_batches_per_epoch):
            ...
            print("{} Training Accuracy = {:.4f} cls_loss = {:.4f} Cov_loss = {:.4f}".format(datetime.now(), accuracy_/batch_size, cls_loss_, cov_loss_))
